...
$(function() {
  ...
  $('.tombolTambahData').on('click', function() {
    ...
    $('.tampilModalUbah').on('click', function() {
      ...
      $('.modal-body form').attr('action', 'http://localhost/materi-pondok-it/Sprint-5/Latihan-2/public/mahasiswa/ubah');
      ...
      $.ajax({
          url: 'http://localhost/materi-pondok-it/Sprint-5/Latihan-2/public/mahasiswa/getubah',
